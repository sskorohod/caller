    ...
    <div className="px-3 py-4 md:p-6 space-y-4 md:space-y-6">
      ...
      <div className="glass-panel rounded-2xl p-4 md:p-6">
        ...
        <button onClick={() => save({ pricing_per_minute: (document.getElementById('price-input') as HTMLInputElement)?.value ?? pricePerMin }, 'pricing')}
          disabled={saving === 'pricing'} className="px-4 py-2 min-h-[44px] md:min-h-0 rounded-xl text-sm font-bold" style={{ background: '#adc6ff', color: '#002e6a' }}>
      ...
      <div className="glass-panel rounded-2xl p-4 md:p-6">
        ...
        }, 'defaults')} disabled={saving === 'defaults'} className="px-4 py-2 min-h-[44px] md:min-h-0 rounded-xl text-sm font-bold mt-4" style={{ background: '#adc6ff', color: '#002e6a' }}>
