      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        ...
        <div className="glass-panel rounded-2xl p-4 md:p-6 space-y-4">
          ...
          <div className="glass-panel rounded-xl p-3" style={{ borderLeft: '3px solid #4ade80' }}>
            <div className="text-xs" style={{ color: '#c2c6d6' }}>Example: $0.05 provider cost</div>
            <div className="flex items-center gap-2 mt-1">
              <span className="text-xs">$0.05</span>
              <span className="text-xs" style={{ color: '#c2c6d6' }}>x {markup}</span>
              <span className="text-xs">=</span>
              <span className="font-mono font-bold" style={{ color: '#4ade80' }}>${clientCost.toFixed(4)}</span>
              <span className="text-xs" style={{ color: '#c2c6d6' }}>client pays</span>
            </div>
          </div>
        </div>
