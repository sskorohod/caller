...
export const articles: Article[] = [
  {
    ...
    title: 'Best LanguageLine Alternative in 2026: AI Phone Translation for $0.20/min',
    titleRu: 'Лучшая альтернатива LanguageLine в 2026: AI-перевод звонков за $0.20/мин',
    description: 'Compare Live Translator vs LanguageLine, Boostlingo, and KUDO. Get real-time phone translation for $0.20/min — no app, no contract, any phone.',
    descriptionRu: 'Сравнение Live Translator с LanguageLine, Boostlingo и KUDO. Перевод звонков в реальном времени за $0.20/мин — без приложений, без контрактов.',
  ...
  },
  {
    ...
    description: 'Пошаговая инструкция: как позвонить в банк, страховую или госорганы в США без хорошего английского. AI-переводчик за $0.20/мин.',
    descriptionRu: 'Пошаговая инструкция: как позвонить в банк, страховую или госорганы в США без хорошего английского. AI-переводчик за $0.20/мин.',
