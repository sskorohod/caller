      ...
      <div className="space-y-5">
        ...
        {docsLoading ? (
          ...
          <div className="bg-white rounded-xl border border-[#e2e8f0] flex flex-col items-center py-20">
            ...
            <p className="text-xs text-[#94a3b8] mt-1 mb-4">Add documents to this knowledge base</p>
            <button onClick={() => setDocModal(true)} className="px-4 py-2 bg-[#6366f1] text-white text-sm font-medium rounded-lg hover:bg-[#4f46e5] transition-colors">Add Document</button>
          </div>
        ) : (
          ...
          <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setDocModal(false)} onKeyDown={e => e.key === 'Escape' && setDocModal(false)} role="dialog" aria-modal="true">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg" onClick={e => e.stopPropagation()}>
              <div className="flex items-center justify-between px-6 py-5 border-b border-[#e2e8f0]">
                <h2 className="text-base font-semibold text-[#0f172a]">Add Document</h2>
              ...
              <form onSubmit={handleAddDoc} className="px-6 py-5 space-y-4">
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-[#475569] uppercase tracking-wide">Title</label>
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-[#475569] uppercase tracking-wide">Type</label>
                ...
                <div className="flex justify-end gap-3 pt-2">
                  <button type="button" onClick={() => setDocModal(false)} className="px-4 py-2.5 text-sm text-[#475569] hover:bg-[#f1f5f9] rounded-lg">Cancel</button>
