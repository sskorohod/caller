...
export function DangerZone() {
  ...
  return (
    <div className="rounded-2xl overflow-hidden" style={{ border: '1px solid var(--th-error-border)', background: 'var(--th-card)' }}>
      <div className="h-1" style={{ background: 'var(--th-error-text)' }} />
      <div className="p-4 md:p-6 space-y-3">
        <div>
          <h3 className="text-sm font-bold" style={{ color: 'var(--th-error-text)' }}>
            {tt('Delete account', 'Удалить аккаунт')}
          </h3>
          <p className="text-xs mt-1 leading-relaxed" style={{ color: 'var(--th-text-muted)' }}>
            {tt(
