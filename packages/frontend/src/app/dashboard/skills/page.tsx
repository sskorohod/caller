  ...
  return (
    <div className="space-y-3 md:space-y-5">
      ...
      {loadError ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-5">
          {packs.map(pack => (
            <div key={pack.id} className="bg-[var(--th-card)] rounded-2xl border border-[var(--th-card-border-subtle)] p-4 md:p-5 hover:border-[var(--th-border)] hover:shadow-[0_4px_16px_var(--th-card-glow)] transition-shadow group shadow-[0_1px_3px_var(--th-shadow),0_8px_24px_var(--th-card-glow)]">
              ...
              <div className="mt-3 flex items-center justify-between">
                ...
                <div className="flex gap-1 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
                  ...
                  <button
                    ...
                    className="p-1.5 min-w-[44px] min-h-[44px] md:min-w-0 md:min-h-0 flex items-center justify-center rounded-lg hover:bg-[var(--th-error-bg)] text-[var(--th-text-muted)] hover:text-[var(--th-error-text)] transition-colors"
                    aria-label="Delete"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
