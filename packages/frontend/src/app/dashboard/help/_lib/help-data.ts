...
Во время звонка на **Главной** видна живая расшифровка.`,
...
During the call, the live transcript is on **Home**.`,
        },
      },
    ],
  },
...
**Это конфиденциально?**
Расшифровки доступны только в вашем аккаунте.
...
**Is it private?**
Transcripts are only available in your account.
