...
- **Translator** (бесплатно) — живой переводчик, $2 кредит при регистрации
- **Agents** ($49/мес) — AI-агенты + всё из Translator, 15-дневный бесплатный пробный период
- **Agents + MCP** ($99/мес) — всё из Agents + API-доступ, 15-дневный пробный период
...
- **Translator** (free) — live translator, $2 credit on signup
- **Agents** ($49/mo) — AI agents + everything in Translator, 15-day free trial
- **Agents + MCP** ($99/mo) — everything in Agents + API access, 15-day free trial
...
При регистрации на план Translator вы получаете **$2 бесплатного кредита** для тестирования платформы.
...
When registering for the Translator plan, you receive **$2 free credit** to test the platform.
