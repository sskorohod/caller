...
import type { Call, TranscriptEntry, RawTranscriptEntry, AiSession, CallDetail, AgentOption, DashboardStats, AdvancedFilters } from './_lib/calls-types';
import { EMPTY_FILTERS, STATUS_COLORS, STATUS_LABELS, SENTIMENT_BADGE, ROLE_LABELS, normalizeTranscript, fmtDuration, fmtDate, fmtDateShort, downloadFile } from './_lib/calls-types';
...
export default function CallsPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Dialer is hidden for now — "Make Call" FAB disabled. */}
