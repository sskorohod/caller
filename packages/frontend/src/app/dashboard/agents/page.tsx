      ...
      {plan && plan === 'translator' && (
        <div className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm"
          ...
          <span style={{ color: '#fbbf24' }}>
            ...
            You can explore and configure agents, but they won&apos;t be active until you upgrade.
          </span>
          <Link href="/dashboard/billing" className="ml-auto px-3 py-1.5 rounded-lg text-xs font-bold whitespace-nowrap shrink-0"
