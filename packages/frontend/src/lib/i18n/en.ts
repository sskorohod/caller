const en: Record<string, string> = {
  ...
  'help.cat.billing': 'Balance & Payments',
  ...
  'help.cat.faq': 'FAQ',
  'help.art.whatIsTranslator': 'What is Live Translator',
  ...
  'settings.telegram.desc': 'Connect your Telegram bot — you’ll get a report after every call and a live-translation link when a call starts.',
  'settings.telegram.how1': 'Open @BotFather in Telegram and create a bot with /newbot.',
  'settings.telegram.how2': 'Copy the bot token and paste it here.',
  'settings.telegram.how3': 'Open your bot and press Start — the chat pairs automatically.',
  'settings.telegram.tokenPlaceholder': 'Bot token from @BotFather',
  'settings.telegram.connect': 'Connect',
  'settings.telegram.disconnect': 'Disconnect',
  'settings.telegram.test': 'Send test',
  'settings.telegram.testOk': 'Sent',
  'settings.telegram.testFail': 'Failed — check the bot',
  'settings.telegram.paired': 'Connected',
  'settings.telegram.awaiting': 'Awaiting pairing — open your bot and press Start',
  'settings.telegram.whatYouGet': 'What you’ll receive: when a call starts — a notification with a live-translation link; after the call — a summary with duration and cost. Bot commands: /live, /pause, /resume, /hangup, /summary.',
  ...
  'settings.phoneNumbersHint': 'Up to 3 phone numbers you call from. Calls from these numbers are billed to this account. Format E.164: +1...',
