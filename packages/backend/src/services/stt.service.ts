...
export class DeepgramSTT extends EventEmitter {
  ...
  connect(options?: { language?: string; model?: string }): void {
    ...
    const url = `wss://api.deepgram.com/v1/listen?model=${model}&language=${lang}&punctuate=true&interim_results=true&endpointing=120&utterance_end_ms=400&vad_events=true&encoding=mulaw&sample_rate=8000&channels=1`;
