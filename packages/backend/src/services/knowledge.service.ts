...
ВАЖНО: НЕ используй markdown-разметку (###, **, -, ```, и т.д.). Пиши ЧИСТЫМ ТЕКСТОМ. Для заголовков секций используй ЗАГЛАВНЫЕ БУКВЫ или формат "Секция:". Для списков используй "- " или нумерацию "1. ". Текст должен быть удобочитаемым в plain text без рендеринга.
